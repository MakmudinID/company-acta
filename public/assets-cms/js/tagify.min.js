...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).Tagify = e() }(this, (function() {
    ...
    function e(t, e, i) { return e in t ? Object.defineProperty(t, e, { value: i, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = i, t }
    ...
    function s(t) {
        for (var s = 1; s < arguments.length; s++) {
            ...
            s % 2 ? i(Object(n), !0).forEach((function(i) { e(t, i, n[i]) })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)) : i(Object(n)).forEach((function(e) { Object.defineProperty(t, e, Object.getOwnPropertyDescriptor(n, e)) }))
        }
        return t
    }
    ...
    var o = function(t, e, i) { return i ? t == e : ("" + t).toLowerCase() == ("" + e).toLowerCase() };

    function r(t) { var e = Object.prototype.toString.call(t).split(" ")[1].slice(0, -1); return t === Object(t) && "Array" != e && "Function" != e && "RegExp" != e && "HTMLUnknownElement" != e }

    function l(t) { var e = document.createElement("div"); return t.replace(/\&#?[0-9a-z]+;/gi, (function(t) { return e.innerHTML = t, e.innerText })) }

    function d(t) { return t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/`|'/g, "&#039;") }

    function c(t, e, i) {
        function s(t, e) { for (var i in e) e.hasOwnProperty(i) && (r(e[i]) ? r(t[i]) ? s(t[i], e[i]) : t[i] = Object.assign({}, e[i]) : t[i] = e[i]) }
        return t instanceof Object || (t = {}), s(t, e), i && s(t, i), t
    }

    function h(t) { return String.prototype.normalize ? "string" == typeof t ? t.normalize("NFD").replace(/[\u0300-\u036f]/g, "") : void 0 : t }
    var g = {
            init: function() { this.DOM.dropdown = this.parseTemplate("dropdown", [this.settings]), this.DOM.dropdown.content = this.DOM.dropdown.querySelector("." + this.settings.classNames.dropdownWrapper) },
            show: function(t) {
                var e, i, s, n = this,
                    a = this.settings,
                ...
                if (t = void 0 === t ? this.state.inputText : t, (!c || d || a.templates.dropdownItemNoMatch) && !1 !== a.dropdown.enable && !this.state.isLoading) {
                    if (clearTimeout(this.dropdownHide__bindEventsTimeout), this.suggestedListItems = this.dropdown.filterListItems.call(this, t), t && !this.suggestedListItems.length && (this.trigger("dropdown:noMatch", t), a.templates.dropdownItemNoMatch && (s = a.templates.dropdownItemNoMatch.call(this, { value: t }))), !s) {
                        if (this.suggestedListItems.length) t && d && !this.state.editing.scope && !o(this.suggestedListItems[0].value, t) && this.suggestedListItems.unshift({ value: t });
                        else {
                    ...
                    this.dropdown.fill.call(this, s), a.dropdown.highlightFirst && this.dropdown.highlightOption.call(this, this.DOM.dropdown.content.children[0]), this.state.dropdown.visible || setTimeout(this.dropdown.events.binding.bind(this)), this.state.dropdown.visible = t || !0, this.state.dropdown.query = t, this.state.selection = { anchorOffset: l.anchorOffset, anchorNode: l.anchorNode }, h || setTimeout((function() { n.dropdown.position.call(n), n.dropdown.render.call(n) })), setTimeout((function() { n.trigger("dropdown:show", n.DOM.dropdown) }))
                }
            },
            hide: function(t) {
                var e = this,
                ...
                if (n && document.body.contains(n) && !a) return window.removeEventListener("resize", this.dropdown.position), this.dropdown.events.binding.call(this, !1), s.setAttribute("aria-expanded", !1), n.parentNode.removeChild(n), setTimeout((function() { e.state.dropdown.visible = !1 }), 100), this.state.dropdown.query = this.state.ddItemData = this.state.ddItemElm = this.state.selection = null, this.state.tag && this.state.tag.value.length && (this.state.flaggedTags[this.state.tag.baseOffset] = this.state.tag), this.trigger("dropdown:hide", n), this
            },
            render: function() {
                var t, e, i, s = this,
                    ...
                    a = this.settings;
                return this.DOM.scope.setAttribute("aria-expanded", !0), document.body.contains(this.DOM.dropdown) || (this.DOM.dropdown.classList.add(a.classNames.dropdownInital), this.dropdown.position.call(this, n), a.dropdown.appendTarget.appendChild(this.DOM.dropdown), setTimeout((function() { return s.DOM.dropdown.classList.remove(a.classNames.dropdownInital) }))), this
            },
            fill: function(t) {
                var e;
                t = "string" == typeof t ? t : this.dropdown.createListHTML.call(this, t || this.suggestedListItems), this.DOM.dropdown.content.innerHTML = (e = t) ? e.replace(/\>[\r\n ]+\</g, "><").replace(/(<.*?>)|\s+/g, (function(t, e) { return e || " " })) : ""
            },
            refilter: function(t) { t = t || this.state.dropdown.query || "", this.suggestedListItems = this.dropdown.filterListItems.call(this, t), this.suggestedListItems.length ? this.dropdown.fill.call(this) : this.dropdown.hide.call(this), this.trigger("dropdown:updated", this.DOM.dropdown) },
            position: function(t) {
            ...
            events: {
                ...
                callbacks: {
                    ...
                    onMouseLeave: function(t) { this.dropdown.highlightOption.call(this) },
                    onClick: function(t) {
                        var e = this;
                        if (0 == t.button && t.target != this.DOM.dropdown) {
                            var i = t.target.closest("." + this.settings.classNames.dropdownItem);
                            this.state.actions.selectOption = !0, setTimeout((function() { return e.state.actions.selectOption = !1 }), 50), this.settings.hooks.suggestionClick(t, { tagify: this, suggestionElm: i }).then((function() { i && e.dropdown.selectOption.call(e, i) })).catch((function(t) { return t }))
                        }
                    },
                    onScroll: function(t) {
                        var e = t.target,
            ...
            selectOption: function(t) {
                ...
                if (this.trigger("dropdown:select", { data: r, elm: t }), this.state.editing ? this.onEditTagDone(this.state.editing.scope, s(s(s({}, this.state.editing.scope.__tagifyTagData), {}, { value: r.value }, r instanceof Object ? r : {}), {}, { __isValid: !0 })) : this.addTags([r], n), setTimeout((function() { e.DOM.input.focus(), e.toggleFocusClass(!0) })), a) return this.dropdown.hide.call(this);
                this.dropdown.refilter.call(this)
            },
            selectAll: function() { return this.suggestedListItems.length = 0, this.dropdown.hide.call(this), this.addTags(this.dropdown.filterListItems.call(this, ""), !0), this },
            filterListItems: function(t) {
                var e, i, s, n, a, o = this,
                    ...
                    p = d.searchKeys,
                    f = 0;
                if (!t || !p.length) return (l.duplicates ? g : g.filter((function(t) { return !o.isTagDuplicate(r(t) ? t.value : t) }))).slice(0, u);

                function m(t, e) { return e.toLowerCase().split(" ").every((function(e) { return t.includes(e.toLowerCase()) })) }
                for (a = d.caseSensitive ? "" + t : ("" + t).toLowerCase(); f < g.length && (e = g[f] instanceof Object ? g[f] : { value: g[f] }, d.fuzzySearch ? (s = p.reduce((function(t, i) { return t + " " + (e[i] || "") }), "").toLowerCase(), d.accentedSearch && (s = h(s), a = h(a)), i = m(s, a)) : i = p.some((function(t) { var i = "" + (e[t] || ""); return d.accentedSearch && (i = h(i), a = h(a)), d.caseSensitive || (i = i.toLowerCase()), 0 == i.indexOf(a) })), n = !l.duplicates && this.isTagDuplicate(r(e) ? e.value : e), i && !n && u-- && c.push(e), 0 != u); f++);
                return c
            },
        ...
        callbacks: {
            ...
            onKeydown: function(t) {
                ...
                switch (t.key) {
                    ...
                    case "Enter":
                        ...
                        t.preventDefault(), setTimeout((function() { e.state.actions.selectOption || e.addTags(i, !0) }))
                }
            },
            onInput: function(t) {
            ...
            onMixTagsInput: function(t) {
                var e, i, s, n, a, o, r, l, d = this,
                    ...
                    m = [].map.call(u, (function(t) { return d.tagData(t).value }));
                if (this.value.slice().forEach((function(t) { t.readonly && !m.includes(t.value) && p.appendChild(d.createTagElem(t)) })), p.childNodes.length && (f.insertNode(p), this.setRangeAtStartEnd(!1, p.lastChild)), u.length != g) return this.value = [].map.call(this.getTagElms(), (function(t) { return d.tagData(t) })), void this.update({ withoutChangeEvent: !0 });
                ...
                if (window.getSelection && (o = window.getSelection()).rangeCount > 0 && 3 == o.anchorNode.nodeType) {
                    if ((f = o.getRangeAt(0).cloneRange()).collapse(!0), f.setStart(o.focusNode, 0), s = (e = f.toString().slice(0, f.endOffset)).split(h.pattern).length - 1, (i = e.match(h.pattern)) && (n = e.slice(e.lastIndexOf(i[i.length - 1]))), n) {
                        if (this.state.actions.ArrowLeft = !1, this.state.tag = { prefix: n.match(h.pattern)[0], value: n.replace(h.pattern, "") }, this.state.tag.baseOffset = o.baseOffset - this.state.tag.value.length, l = this.state.tag.value.match(h.delimiters)) return this.state.tag.value = this.state.tag.value.replace(h.delimiters, ""), this.state.tag.delimiters = l[0], this.addTags(this.state.tag.value, h.dropdown.clearOnSelect), void this.dropdown.hide.call(this);
                        a = this.state.tag.value.length >= h.dropdown.enabled;
                        try { r = (r = this.state.flaggedTags[this.state.tag.baseOffset]).prefix == this.state.tag.prefix && r.value[0] == this.state.tag.value[0], this.state.flaggedTags[this.state.tag.baseOffset] && !this.state.tag.value && delete this.state.flaggedTags[this.state.tag.baseOffset] } catch (t) {}(r || s < this.state.mixMode.matchedPatternCount) && (a = !1)
                    } else this.state.flaggedTags = {};
                    this.state.mixMode.matchedPatternCount = s
                }
                setTimeout((function() { d.update({ withoutChangeEvent: !0 }), d.trigger("input", c({}, d.state.tag, { textContent: d.DOM.input.textContent })), d.state.tag && d.dropdown[a ? "show" : "hide"].call(d, d.state.tag.value) }), 10)
            },
            ...
            onEditTagInput: function(t, i) {
                ...
                r || !0 !== t.originalIsValid || (l = !0), s.classList.toggle(this.settings.classNames.tagInvalid, !0 !== l), a.__isValid = l, s.title = !0 === l ? a.title || a.value : l, o.length >= this.settings.dropdown.enabled && (this.state.editing.value = o, this.dropdown.show.call(this, o)), this.trigger("edit:input", { tag: s, index: n, data: c({}, this.value[n], { newValue: o }), originalEvent: this.cloneEvent(i) })
            },
            onEditTagFocus: function(t) { this.state.editing = { scope: t, input: t.querySelector("[contenteditable]") } },
                ...
                if (this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(t)) {
                    ...
                    if (r) {
                        if (i.transformTag.call(this, o), !0 !== (l = this.validateTag(e({}, i.tagTextProp, o[i.tagTextProp])))) {
                            if (this.trigger("invalid", { data: o, tag: s, message: l }), i.editTags.keepInvalid) return;
                            o = a
                        } else if (o = this.getWhitelistItem(n) || o.__preInvalidData || o, !0 !== (l = this.validateTag(o))) {
                            if (this.trigger("invalid", { data: o, tag: s, message: l }), s.classList.toggle(i.classNames.tagInvalid, !0), i.editTags.keepInvalid) return;
                            o = a
                        }
            ...
            onDoubleClickScope: function(t) {
                var e, i, s = t.target.closest("." + this.settings.classNames.tag),
                    n = this.settings;
                s && (e = s.classList.contains(this.settings.classNames.tagEditing), i = s.hasAttribute("readonly"), "select" == n.mode || n.readonly || e || i || !this.settings.editTags || this.editTag(s), this.toggleFocusClass(!0), this.trigger("dblclick", { tag: s, index: this.getNodeIndex(s), data: this.tagData(s) }))
            }
        }
    };
    ...
    function f(e, i) {
        return e ? e.previousElementSibling && e.previousElementSibling.classList.contains("tagify") ? (console.warn("Tagify: ", "input element is already Tagified", e), this) : (c(this, function(e) {
            ...
            function s(t, e, s) { s && e.split(/\s+/g).forEach((function(e) { return i[t + "EventListener"].call(i, e, s) })) }
            return {
                off: function(t, e) { return s("remove", t, e), this },
                on: function(t, e) { return e && "function" == typeof e && s("add", t, e), this },
    ...
    return f.prototype = {
        ...
        parseTemplate: function(t, e) { return t = this.settings.templates[t] || t, this.parseHTML(t.apply(this, e)) },
        applySettings: function(t, e) {
            ...
            if (i.readonly = t.hasAttribute("readonly"), i.placeholder = t.getAttribute("placeholder") || i.placeholder || "", i.required = t.hasAttribute("required"), this.isIE && (i.autoComplete = !1), ["whitelist", "blacklist"].forEach((function(e) {
                ...
                })), "autoComplete" in e && !r(e.autoComplete) && (i.autoComplete = this.DEFAULTS.autoComplete, i.autoComplete.enabled = e.autoComplete), "mix" == i.mode && (i.autoComplete.rightKey = !0, i.delimiters = e.delimiters || null), t.pattern) try { i.pattern = new RegExp(t.pattern) } catch (t) {}
        ...
        getCaretGlobalPosition: function() {
            ...
            if (t.rangeCount) {
                var e, i, s = t.getRangeAt(0),
                    n = s.startContainer,
                    a = s.startOffset;
                if (a > 0) return (i = document.createRange()).setStart(n, a - 1), i.setEnd(n, a), { left: (e = i.getBoundingClientRect()).right, top: e.top, bottom: e.bottom };
        ...
        getCSSVars: function() {
            ...
            this.CSSVars = { tagHideTransition: function(t) { var e = t.value; return "s" == t.unit ? 1e3 * e : e }(function(t) { if (!t) return {}; var e = (t = t.trim().split(" ")[0]).split(/\d+/g).filter((function(t) { return t })).pop().trim(); return { value: +t.split(e).filter((function(t) { return t }))[0].trim(), unit: e } }((t = "tag-hide-transition", e.getPropertyValue("--" + t)))) }
        },
        build: function(t) {
            var e = this.DOM;
        ...
        destroy: function() { this.DOM.scope.parentNode.removeChild(this.DOM.scope), this.dropdown.hide.call(this, !0), clearTimeout(this.dropdownHide__bindEventsTimeout) },
        loadOriginalValues: function(t) {
            ...
            if (t = t || (i.mixMode.integrated ? this.DOM.input.textContent : this.DOM.originalInput.value))
                if (this.removeAllTags(), "mix" == i.mode) this.parseMixTags(t.trim()), (e = this.DOM.input.lastChild) && "BR" == e.tagName || this.DOM.input.insertAdjacentHTML("beforeend", "<br>");
                    ...
                    this.addTags(t).forEach((function(t) { return t && t.classList.add(i.classNames.tagNoAnimation) }))
                }
        ...
        cloneEvent: function(t) { var e = {}; for (var i in t) e[i] = t[i]; return e },
        loading: function(t) { return this.state.isLoading = t, this.DOM.scope.classList[t ? "add" : "remove"](this.settings.classNames.scopeLoading), this },
        tagLoading: function(t, e) { return t && t.classList[e ? "add" : "remove"](this.settings.classNames.tagLoading), this },
        toggleFocusClass: function(t) { this.DOM.scope.classList.toggle(this.settings.classNames.focus, !!t) },
        ...
        insertAfterTag: function(t, e) { if (e = e || this.settings.mixMode.insertAfterTag, t && e) return e = "string" == typeof e ? document.createTextNode(e) : e, t.appendChild(e), t.parentNode.insertBefore(e, t.nextSibling), e },
        editTag: function(t, e) {
            var i = this;
            t = t || this.getLastTag(), e = e || {}, this.dropdown.hide.call(this);
            var s = this.settings;

            function n() { return t.querySelector("." + s.classNames.tagText) }
            var a = n(),
                ...
                d = this,
                h = !0;
            if (a) { if (!(r instanceof Object && "editable" in r) || r.editable) return a.setAttribute("contenteditable", !0), t.classList.add(s.classNames.tagEditing), this.tagData(t, { __originalData: c({}, r), __originalHTML: t.innerHTML }), a.addEventListener("focus", l.onEditTagFocus.bind(this, t)), a.addEventListener("blur", (function() { setTimeout((function() { return l.onEditTagBlur.call(d, n()) })) })), a.addEventListener("input", l.onEditTagInput.bind(this, a)), a.addEventListener("keydown", (function(e) { return l.onEditTagkeydown.call(i, e, t) })), a.focus(), this.setRangeAtStartEnd(!1, a), e.skipValidation || (h = this.editTagToggleValidity(t, r.value)), a.originalIsValid = h, this.trigger("edit:start", { tag: t, index: o, data: r, isValid: h }), this } else console.warn("Cannot find element in Tag template: .", s.classNames.tagText)
        },
        ...
        onEditTagDone: function(t, e) {
            ...
            var i = { tag: t = t || this.state.editing.scope, index: this.getNodeIndex(t), data: e };
        ...
        updateValueByDOMTags: function() {
            var t = this;
            this.value.length = 0, [].forEach.call(this.getTagElms(), (function(e) { e.classList.contains(t.settings.classNames.tagNotAllowed) || t.value.push(t.tagData(e)) })), this.update()
        },
        setRangeAtStartEnd: function(t, e) { t = "number" == typeof t ? t : !!t, e = (e = e || this.DOM.input).lastChild || e; var i = document.getSelection(); try { i.rangeCount >= 1 && ["Start", "End"].forEach((function(s) { return i.getRangeAt(0)["set" + s](e, t || e.length) })) } catch (t) { console.warn("Tagify: ", t) } },
        injectAtCaret: function(t, e) { if (e = e || this.state.selection.range) return "string" == typeof t && (t = document.createTextNode(t)), e.deleteContents(), e.insertNode(t), this.setRangeAtStartEnd(!1, t), this.updateValueByDOMTags(), this.update(), this },
        input: {
            set: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
            ...
            validate: function() { var t = !this.state.inputText || !0 === this.validateTag({ value: this.state.inputText }); return this.DOM.input.classList.toggle(this.settings.classNames.inputInvalid, !t), t },
            normalize: function(t) {
                var e = t || this.DOM.input,
                    i = [];
                e.childNodes.forEach((function(t) { return 3 == t.nodeType && i.push(t.nodeValue) })), i = i.join("\n");
        ...
        getTagIdx: function(t) { return this.value.findIndex((function(e) { return JSON.stringify(e) == JSON.stringify(t) })) },
        ...
        getTagElms: function() { for (var t = arguments.length, e = new Array(t), i = 0; i < t; i++) e[i] = arguments[i]; var s = ["." + this.settings.classNames.tag].concat(e).join("."); return [].slice.call(this.DOM.scope.querySelectorAll(s)) },
        getLastTag: function() { var t = this.DOM.scope.querySelectorAll(".".concat(this.settings.classNames.tag, ":not(.").concat(this.settings.classNames.tagHide, "):not([readonly])")); return t[t.length - 1] },
        tagData: function(t, e) { return t ? (e && (t.__tagifyTagData = c({}, t.__tagifyTagData || {}, e)), t.__tagifyTagData) : (console.warn("tag elment doesn't exist", t, e), e) },
        isTagDuplicate: function(t, e) {
            var i = this,
                s = this.settings;
            return "select" != s.mode && this.value.reduce((function(n, a) { return o(i.trim("" + t), a.value, e || s.dropdown.caseSensitive) ? n + 1 : n }), 0)
        },
        getTagIndexByValue: function(t) {
            var e = this,
                i = [];
            return this.getTagElms().forEach((function(s, n) { o(e.trim(s.textContent), t, e.settings.dropdown.caseSensitive) && i.push(n) })), i
        },
        getTagElmByValue: function(t) { var e = this.getTagIndexByValue(t)[0]; return this.getTagElms()[e] },
        flashTag: function(t) {
            var e = this;
            t && (t.classList.add(this.settings.classNames.tagFlash), setTimeout((function() { t.classList.remove(e.settings.classNames.tagFlash) }), 100))
        },
        isTagBlacklisted: function(t) { return t = this.trim(t.toLowerCase()), this.settings.blacklist.filter((function(e) { return ("" + e).toLowerCase() == t })).length },
        isTagWhitelisted: function(t) { return !!this.getWhitelistItem(t) },
        getWhitelistItem: function(t, e, i) {
            e = e || "value";
            var s, n = this.settings,
                a = (i = i || n.whitelist, n.dropdown.caseSensitive);
            return i.some((function(i) { var n = "string" == typeof i ? i : i[e]; if (o(n, t, a)) return s = "string" == typeof i ? { value: i } : i, !0 })), s || "value" != e || "value" == n.tagTextProp || (s = this.getWhitelistItem(t, n.tagTextProp, i)), s
        },
        ...
        getInvalidTagAttrs: function(t, e) { return { "aria-invalid": !0, class: "".concat(t.class || "", " ").concat(this.settings.classNames.tagNotAllowed).trim(), title: e } },
        hasMaxTags: function() { return this.value.length >= this.settings.maxTags && this.TEXTS.exceed },
        ...
        normalizeTags: function(t) {
            var i = this,
                ...
                g = function(t) { return (t + "").split(o).filter((function(t) { return t })).map((function(t) { return e({}, l, i.trim(t)) })) };
            if ("number" == typeof t && (t = t.toString()), "string" == typeof t) {
                if (!t.trim()) return [];
                t = g(t)
            } else if (h) {
                var u;
                t = (u = []).concat.apply(u, n(t.map((function(t) { return t.value ? t : g(t) }))))
            }
            return c && (t.forEach((function(t) {
                var e = d.map((function(t) { return t.value })),
                    s = i.dropdown.filterListItems.call(i, t[l]).filter((function(t) { return !e.includes(t.value) })),
        ...
        parseMixTags: function(t) {
            ...
            return t = t.split(s[0]).map((function(t, i) {
                ...
                try {
                    if (p == +p) throw Error;
                    h = JSON.parse(p)
                } catch (t) { h = e.normalizeTags(p)[0] }
                if (f || !(u.length > 1) || o && !e.isTagWhitelisted(h.value) || !n && e.isTagDuplicate(h.value)) { if (t) return i ? s[0] + t : t } else a.call(e, h), h[c = h[l] ? l : "value"] = e.trim(h[c]), g = e.createTagElem(h), d.push(h), g.classList.add(e.settings.classNames.tagNoAnimation), u[0] = g.outerHTML, e.value.push(h);
                return u.join("")
            })).join(""), this.DOM.input.innerHTML = t, this.DOM.input.appendChild(document.createTextNode("")), this.DOM.input.normalize(), this.getTagElms().forEach((function(t, i) { return e.tagData(t, d[i]) })), this.update({ withoutChangeEvent: !0 }), t
        },
        ...
        selectTag: function(t, e) { if (!this.settings.enforceWhitelist || this.isTagWhitelisted(e.value)) return this.input.set.call(this, e.value, !0), this.state.actions.selectOption && setTimeout(this.setRangeAtStartEnd.bind(this)), this.getLastTag() ? this.replaceTag(this.getLastTag(), e) : this.appendTag(t), this.value[0] = e, this.trigger("add", { tag: t, data: e }), this.update(), [t] },
        ...
        addTags: function(t, e) {
            ...
            return t && 0 != t.length ? (t = this.normalizeTags(t), "mix" == a.mode ? this.addMixTags(t) : ("select" == a.mode && (e = !1), this.DOM.input.removeAttribute("style"), t.forEach((function(t) {
                ...
                if ((t = Object.assign({}, r)).__isValid = i.hasMaxTags() || i.validateTag(t), a.transformTag.call(i, t), !0 !== t.__isValid) {
                    if (s) return;
                    c(o, i.getInvalidTagAttrs(t, t.__isValid), { __preInvalidData: r }), t.__isValid == i.TEXTS.duplicate && i.flashTag(i.getTagElmByValue(t.value))
                }
                if (t.readonly && (o["aria-readonly"] = !0), e = i.createTagElem(c({}, t, o)), n.push(e), "select" == a.mode) return i.selectTag(e, t);
                i.appendTag(e), t.__isValid && !0 === t.__isValid ? (i.value.push(t), i.update(), i.trigger("add", { tag: e, index: i.value.length - 1, data: t })) : (i.trigger("invalid", { data: t, index: i.value.length, tag: e, message: t.__isValid }), a.keepInvalidTags || setTimeout((function() { return i.removeTags(e, !0) }), 1e3)), i.dropdown.position.call(i)
        ...
        addMixTags: function(t) {
            ...
            return s.transformTag.call(this, t[0]), t[0].prefix = t[0].prefix || this.state.tag ? this.state.tag.prefix : (s.pattern.source || s.pattern)[0], e = this.createTagElem(t[0]), this.replaceTextWithNode(e) || this.DOM.input.appendChild(e), setTimeout((function() { return e.classList.add(i.settings.classNames.tagNoAnimation) }), 300), this.value.push(t[0]), this.update(), !n && setTimeout((function() {
                var t = i.insertAfterTag(e) || e;
                i.placeCaretAfterNode(t)
            }), this.isFirefox ? 100 : 0), this.state.tag = null, this.trigger("add", c({}, { tag: e }, { data: t[0] })), e
        },
        ...
        createTagElem: function(t) {
            var e, i = c({}, t, { value: d(t.value + "") });
            return this.settings.readonly && (t.readonly = !0),
                function(t) { for (var e, i = document.createNodeIterator(t, NodeFilter.SHOW_TEXT); e = i.nextNode();) e.textContent.trim() || e.parentNode.removeChild(e) }(e = this.parseTemplate("tag", [i])), this.tagData(e, t), e
        },
        reCheckInvalidTags: function() {
            ...
            [].forEach.call(s, (function(e) {
                var i = t.tagData(e),
                    ...
                    n = !0 === t.validateTag(i);
                s && n && (i = i.__preInvalidData ? i.__preInvalidData : { value: i.value }, t.replaceTag(e, i))
            }))
        },
        removeTags: function(t, e, i) {
            var s, n = this;
            t = t && t instanceof HTMLElement ? [t] : t instanceof Array ? t : t ? [t] : [this.getLastTag()], s = t.reduce((function(t, e) { return e && "string" == typeof e && (e = n.getTagElmByValue(e)), e && t.push({ node: e, idx: n.getTagIdx(n.tagData(e)), data: n.tagData(e, { __removed: !0 }) }), t }), []), i = "number" == typeof i ? i : this.CSSVars.tagHideTransition, "select" == this.settings.mode && (i = 0, this.input.set.call(this)), 1 == s.length && s[0].node.classList.contains(this.settings.classNames.tagNotAllowed) && (e = !0), s.length && this.settings.hooks.beforeRemoveTag(s, { tagify: this }).then((function() {
                ...
                i && i > 10 && 1 == s.length ? function(e) { e.node.style.width = parseFloat(window.getComputedStyle(e.node).width) + "px", document.body.clientTop, e.node.classList.add(this.settings.classNames.tagHide), setTimeout(t.bind(this), i, e) }.call(n, s[0]) : s.forEach(t.bind(n)), e || (s.forEach((function(t) {
        ...
        removeAllTags: function() { this.value = [], "mix" == this.settings.mode ? this.DOM.input.innerHTML = "" : Array.prototype.slice.call(this.getTagElms()).forEach((function(t) { return t.parentNode.removeChild(t) })), this.dropdown.position.call(this), "select" == this.settings.mode && this.input.set.call(this), this.update() },
        postUpdate: function() {
        ...
        update: function(t) {
            var e, i, s = this.DOM.originalInput,
                ...
                a = (e = this.value, i = ["__isValid", "__removed"], e.map((function(t) { var e = {}; for (var s in t) i.indexOf(s) < 0 && (e[s] = t[s]); return e })));
