						...
						<div class="row clearfix">
                            ...
                            <div class="footer-column col-lg-7 col-md-6 col-sm-12">
                                <div class="footer-widget logo-widget">
									<div class="logo">
										<a href="index.html"><img src="<?php echo base_url() ?>/assets/images/logo-2.png" alt="" /></a>
									</div>
							...
							<div class="footer-column col-lg-6 col-md-6 col-sm-12">
								<div class="footer-widget news-widget">
									...
									<div class="widget-content">
										<div class="post">
											<div class="thumb"><a href="news-detail.html"><img src="<?php echo base_url() ?>/assets/images/resource/post-thumb-3.jpg" alt=""></a></div>
											<h6><a href="news-detail.html">Define World Best IT Solution Technology</a></h6>
											<span class="date">May 01, 2020</span>
										</div>

										<div class="post">
											<div class="thumb"><a href="news-detail.html"><img src="<?php echo base_url() ?>/assets/images/resource/post-thumb-4.jpg" alt=""></a></div>
