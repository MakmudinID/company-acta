        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-header d-flex">
                    ...
                    <button type="button" class="btn btn-sm btn-primary add"><i class="fa fa-plus-circle"></i> <b>Mitra</b></button>
                </div>
                <div class="card-body">
...
<div class="modal modal-cover fade" id="mdl-mitra">
            ...
            <form role="form" id="form">
                <div class="modal-body">
                    ...
                    <div class="form-group row mb-3" id="row-display" style="display:none">
                        <div class="col-sm-6">
                            <label class="form-label" for="preview"><b>Preview Mitra</b></label><br>
