        ...
        <div class="col-xl-12">
			...
			<div class="card">
				<div class="card-header d-flex">
					...
					<button type="button" class="btn btn-sm btn-primary add"><i class="fa fa-plus"></i> <b>Tambah Sub Menu</b></button>
				</div>
				<div class="card-body">
...
<div class="modal fade" id="mdl-submenu">
        ...
        <div class="modal-content">
            ...
            <form role="form" id="form">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="url">URL <small class="text-danger">(Diawali: / )</small></label>
