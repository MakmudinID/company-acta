        ...
        <div class="col-xl-12">
            ...
            <div class="card mb-3">
                <div class="card-header d-flex">
                    <span class="flex-grow-1"><b>SLIDER <?php echo $mysubmenu ?></b></span>
                    <button type="button" class="btn btn-sm btn-primary add" data-bs-toggle="modal" data-bs-target="#modal-default"><i class="fa fa-plus-circle"></i> <b>Slider</b></button>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="table" class="table table-striped table-sm table-hover text-nowrap" style="width:100%">
                            <thead>
        ...
        <div class="modal-content">
            ...
            <form role="form" id="form">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="title_normal">Title Normal</label>
                        <input type="text" class="form-control" id="title_normal" name="title_normal">
                    </div>
                    <div class="form-group mb-3">
                        <label for="title_bold">Title Bold</label>
                        <input type="text" class="form-control" id="title_bold" name="title_bold">
                    </div>
                    <div class="form-group mb-3">
                ...
                <div class="modal-footer justify-content-between" id="foot">
